...
import com.cito.sinide.model.factory.CerberusUserFactory;
import com.cito.sinide.model.security.CerberusUser;
...
public class UserDetailsServiceImpl implements UserDetailsService {
  ...
  public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
    ...
    user.setAuthorities(user.getAuthorities()+", ONLINE");
    if (user == null) {
